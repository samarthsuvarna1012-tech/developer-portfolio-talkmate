  ...
  return (
    <div className="fixed inset-0 pointer-events-none overflow-hidden z-0 bg-[#030712]">
      ...
      <div ref={containerRef} className="absolute inset-0 pointer-events-none transition-transform duration-75 ease-out">
        ...
        <div 
          className="absolute top-[15%] left-[5%] w-[55vw] h-[55vw] max-w-[650px] max-h-[650px] rounded-full bg-[radial-gradient(circle,rgba(6,182,212,0.12)_0%,rgba(99,102,241,0.06)_50%,transparent_75%)] blur-[120px] pointer-events-none animate-pulse"
          style={{ animationDuration: '10s' }}
        />
        <div 
          className="absolute top-[35%] right-[-5%] w-[50vw] h-[50vw] max-w-[600px] max-h-[600px] rounded-full bg-[radial-gradient(circle,rgba(124,77,255,0.12)_0%,rgba(14,165,233,0.05)_55%,transparent_75%)] blur-[130px] pointer-events-none animate-pulse"
          style={{ animationDuration: '14s', animationDelay: '2s' }}
        />
        <div 
          className="absolute -bottom-[10%] left-[25%] w-[45vw] h-[45vw] max-w-[550px] max-h-[550px] rounded-full bg-[radial-gradient(circle,rgba(168,85,247,0.1)_0%,rgba(6,182,212,0.05)_50%,transparent_75%)] blur-[140px] pointer-events-none animate-pulse"
      ...
      <div 
        className="absolute inset-0 opacity-[0.035] bg-[linear-gradient(to_right,#38bdf8_1px,transparent_1px),linear-gradient(to_bottom,#38bdf8_1px,transparent_1px)] bg-[size:4rem_4rem] [mask-image:radial-gradient(ellipse_60%_50%_at_50%_50%,#000_70%,transparent_100%)]"
      />

      {/* Vignette Rim Light */}
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,transparent_45%,rgba(3,7,18,0.75)_100%)] pointer-events-none" />
    </div>
  );
});
