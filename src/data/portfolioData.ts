...
export const PORTFOLIO_PROJECTS: Project[] = [
  ...
  },
  {
    ...
    description: 'An AI-powered software engineering and coding platform focused on understanding projects, generating and modifying code, workspace intelligence, and developer assistance.',
    category: 'DevTools',
    tags: ['React', 'TypeScript', 'Node.js', 'Gemini API', 'Developer Tools'],
    link: 'https://codemaker-ai.vercel.app/',
    githubUrl: 'https://github.com/samarthsuvarna1012-tech/codemaker-ai',
    isFeatured: true,
    stats: 'Major Project • Workspace Prototype',
    status: 'live',
